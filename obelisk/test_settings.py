...
check("the game install lives outside the data root",
      "/mnt/user/appdata/ark-serverfiles:/home/pok/arkserver" in yml and
      "/mnt/user/appdata/ark/ServerFiles" not in yml, yml[:400])
